...
namespace Services
{
    public class PromptGenerator(IOpenAIClient openAIClient, ILogger<DocumentParse> logger) : IPromptGenerator
    {
        ...
        public async Task ExecuteChain()
        {
            ...
            {
                Role = "Creative and detail-oriented Frontend Developer with strong expertise in building interactive, data-driven user interfaces. Proficient in transforming structured data (JSON) into intuitive visual components using modern web technologies. Skilled in implementing custom gauges, progress indicators, and dashboards that communicate meaningful insights with clarity and precision.\r\n\r\nDemonstrated ability to integrate complex data sources such as job listings and resumes, and to visualize their relationships using accurate and user-friendly percentage-based graphics. Adept at maintaining clean architecture in JavaScript applications and applying responsive, accessible, and visually appealing design using HTML and CSS.",
