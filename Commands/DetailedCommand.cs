...
namespace Commands
{
    public class DetailedCommand : ICommand
    {
        private readonly IJobSearchCoordinator _linkedInService;
        private readonly ILogger<DetailedCommand> _logger;
        private readonly IJobStorageService _storageService;

        public DetailedCommand(IJobSearchCoordinator linkedInService, ILogger<DetailedCommand> logger, IJobStorageService storageService)
        {
